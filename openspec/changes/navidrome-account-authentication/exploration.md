...
8. **Work-unit ordering and dependency direction** —
   ...
   - (superseded — canonical delivery strategy is chained PRs: A/#48 planning+WU1, B/#49 WU2, C WU3, D WU4, WU5 gated. Earlier "one feature branch/PR as approved; no pre-split" is historical audit context only.)
...
- **400-line PR budget**: each chained PR stays within the 400-line review-workload guard. PR A/#48 = planning + WU1 auth core; PR B/#49 = WU2 secure-secret-storage; PR C = WU3 authenticated-network-boundary; PR D = WU4 session/UI. (superseded — older PR-A=auth boundary / PR-B=session UI+WU5 split is historical audit context only.)
